...
class Qwen2Attention(nn.Module):
    ...
    def __init__(
        ...
        # NOTE: Qwen2.5 does NOT use QK norm (unlike Qwen3)
    ...
    def forward(
        ...
        # No QK norm for Qwen2.5 (Qwen3 applies RMSHeadNorm on q and k here)
...
class Qwen2DecoderLayer(nn.Module):
    ...
    def __init__(
        ...
        self.self_attn = Qwen2Attention(
            ...
            qkv_bias=True,  # Qwen2.5 uses bias in QKV projections
...
class Qwen2ForCausalLM(nn.Module):
    ...
    def __init__(
        ...
        assert not (tp_group is None and self.tp_size > 1), "ERROR in Qwen2ForCausalLM: tp_group is None and tp_size > 1"

        print(f'Starting Qwen2ForCausalLM init, draft={draft}, speculate={speculate}, spec_k={spec_k}')
        self.model = Qwen2Model(config, draft, speculate, spec_k, async_fan_out, draft_async, tp_group=tp_group, tp_size=self.tp_size)
        self.async_fan_out = async_fan_out
